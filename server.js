...
const Manga = mongoose.model('Manga', new mongoose.Schema({
    ...
    thai_url: String, thai_url_Buy: String, eng_url: String, eng_url_Buy: String, original_url: String, original_url_Buy: String, facebook_post_url: { type: String, default: "" }, updated_at: String
}));
